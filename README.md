...
<p align="left">
  ...
  <p>Define la visibilidad del método por ejemplo <code>public</code> <code>private</code></p>
  
  <details>
    <summary>ver más</summary>
    <p><code>public</code> permite el acceso desde cualquier clase, mientras que <code>private</code> restringe su uso únicamente dentro de la misma clase.</p>
  </details>
</details>
...
<details>
  ...
  Define la visibilidad del método por ejemplo `public` `private`.

  <details>
    <summary>ver más</summary>
    
    `public` permite el acceso desde cualquier clase, mientras que  
    `private` restringe su uso únicamente dentro de la misma clase.
  </details>
</details>
