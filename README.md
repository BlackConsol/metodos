...
<details>
    ...
    <details>
        <summary align="center">ver mas</summary>
        <p align="star"> el tipo de dato que el método devolverá tras su ejecución, pudiendo ser tipos primitivos <code>int</code>, <code>boolean</code etc, objetos o void si             no retorna ningún valor.
        </p>
    </details>
</details>
